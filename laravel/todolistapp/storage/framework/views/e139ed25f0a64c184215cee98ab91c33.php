                ...
                <div class="card-body">
                    ...
                    <form id="deleteForm" action="<?php echo e(route('todo.destroy', $todo->id)); ?>" method="POST">
                        ...
                        <div id="confirmationPopup" class="confirmation-popup" style="display: none;">
                            ...
                            <button class="btn btn-danger btn-sm mr-2" onclick="confirmDelete()">Yes</button>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/aaronadom-malm/Desktop/laravel/todolistapp/resources/views/todo/show.blade.php ENDPATH**/ ?>